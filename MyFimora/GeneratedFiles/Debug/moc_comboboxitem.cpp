...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ComboboxItem_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ComboboxItem_t qt_meta_stringdata_ComboboxItem = {
    {
QT_MOC_LITERAL(0, 0, 12), // "ComboboxItem"
QT_MOC_LITERAL(1, 13, 19), // "singalChooseAccount"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 25), // "signalCurrentIndexChanged"
QT_MOC_LITERAL(4, 60, 6), // "iIndex"
QT_MOC_LITERAL(5, 67, 9) // "slotEmpty"

    },
    "ComboboxItem\0singalChooseAccount\0\0"
    "signalCurrentIndexChanged\0iIndex\0"
    "slotEmpty"
};
...
void ComboboxItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->singalChooseAccount((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->signalCurrentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->slotEmpty(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ComboboxItem::singalChooseAccount)) {
                *result = 0;
            }
        }
        {
            typedef void (ComboboxItem::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ComboboxItem::signalCurrentIndexChanged)) {
                *result = 1;
            }
        }
    }
...
void *ComboboxItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ComboboxItem.stringdata))
...
// SIGNAL 0
void ComboboxItem::singalChooseAccount(const QString & _t1)
{
...
// SIGNAL 1
void ComboboxItem::signalCurrentIndexChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
