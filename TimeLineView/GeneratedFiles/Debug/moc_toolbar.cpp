...
QT_MOC_LITERAL(3, 17, 7), // "btnType"
QT_MOC_LITERAL(4, 25, 4), // "type"
QT_MOC_LITERAL(5, 30, 19) // "signalButtonClicked"

    },
    "ToolBar\0clicked\0\0btnType\0type\0"
    "signalButtonClicked"
};
...
void ToolBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< btnType(*)>(_a[1]))); break;
        case 1: _t->signalButtonClicked((*reinterpret_cast< btnType(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ToolBar::*_t)(btnType );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ToolBar::clicked)) {
                *result = 0;
            }
        }
        {
            typedef void (ToolBar::*_t)(btnType );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ToolBar::signalButtonClicked)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void ToolBar::clicked(btnType _t1)
{
...
// SIGNAL 1
void ToolBar::signalButtonClicked(btnType _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
