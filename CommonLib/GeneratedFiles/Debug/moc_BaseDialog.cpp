...
#include "../../../include/inc_CommonLib/BaseDialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BaseDialog_t, stringdata) + ofs \
...
void *BaseDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BaseDialog.stringdata))
