...
__inline char* __w2a(char* buf, const wchar_t* s, int count)
{
	...
	WtoUTF8(buf1, -1, buf, count, false);
#endif
...
#ifdef WIN32
	nLen = (int)strlen(s);
	MultiByteToWideChar( CP_ACP, 0, (char*)buf1, -1,
		buf, nLen + 1);
#else
	//mbstowcs(buf, s, count);
	UTF8toW((char*)buf1, -1, buf, count, false);
#endif
...
#define W2A(s) 		__w2a((char*)sz_conv_temp, s, STRMAXSIZE)
#define A2W(s) 		__a2w((wchar_t*)sz_conv_temp, s, STRMAXSIZE)

#define A2T(s)		__a2t((TCHAR*)sz_conv_temp,s, STRMAXSIZE)
#define W2T(s) 		__w2t((TCHAR*)sz_conv_temp, s, STRMAXSIZE)

#define T2A(s) 		__t2a((char*)sz_conv_temp, s, STRMAXSIZE)
#define T2W(s) 		__t2w((wchar_t*)sz_conv_temp, s, STRMAXSIZE)

#define W32TOW16(s)	__w32tow16((wchar_t*)sz_conv_temp, s, STRMAXSIZE)
