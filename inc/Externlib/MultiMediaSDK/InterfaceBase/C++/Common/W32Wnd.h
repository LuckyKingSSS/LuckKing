...
protected:
	...
	virtual BOOL PreTranslateMessage(UINT message, WPARAM wParam, LPARAM lParam)
	{
		return TRUE;
	}
...
#define ON_W32MESSAGE_RANGE(msgFirst, msgLast, func) \
...
#define ON_W32COMMAND_ID(id, func) \
...
#define ON_W32COMMAND_CODE(code, func) \
...
#define ON_W32NOTIFY_IDR(id, func) \
...
#define ON_W32NOTIFY_CODE(cd, func) \
